...
cdef extern from "flint/fmpq_poly.h":
    ...
    void _fmpq_poly_integral_offset(fmpz_struct * rpoly, fmpz_t rden, const fmpz_struct * poly, const fmpz_t den, slong len, slong m)
    ...
    void _fmpq_poly_sin_cos_series_basecase(fmpz_struct * S, fmpz_t Sden, fmpz_struct * C, fmpz_t Cden, const fmpz_struct * A, const fmpz_t Aden, slong Alen, slong n)
    void _fmpq_poly_sin_cos_series_newton(fmpz_struct * S, fmpz_t Sden, fmpz_struct * C, fmpz_t Cden, const fmpz_struct * h, const fmpz_t hden, slong hlen, slong cutoff, slong n)
    ...
    void _fmpq_poly_compose_series_kinoshita_li(fmpz_struct * res, fmpz_t den, const fmpz_struct * poly1, const fmpz_t den1, slong len1, const fmpz_struct * poly2, const fmpz_t den2, slong len2, slong n)
