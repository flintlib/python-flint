...
cdef extern from "flint/fmpz_poly.h":
    ...
    void _fmpz_poly_div_root_fmpz(fmpz_struct * Q, const fmpz_struct * A, slong len, const fmpz_t c)
    ...
    void _fmpz_poly_divexact_root_fmpq(fmpz_struct * Q, const fmpz_struct * A, slong len, const fmpq_t c)
    ...
    int _fmpz_poly_interpolate_newton(fmpz_struct * poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    int fmpz_poly_interpolate_newton(fmpz_poly_t poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    int _fmpz_poly_interpolate_multi_mod(fmpz_struct * poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    int fmpz_poly_interpolate_multi_mod(fmpz_poly_t poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    int _fmpz_poly_interpolate(fmpz_struct * poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    int fmpz_poly_interpolate(fmpz_poly_t poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    void _fmpz_poly_interpolate_exact_newton(fmpz_struct * poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    void fmpz_poly_interpolate_exact_newton(fmpz_poly_t poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    void _fmpz_poly_interpolate_exact(fmpz_struct * poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    void fmpz_poly_interpolate_exact(fmpz_poly_t poly, const fmpz_struct * xs, const fmpz_struct * ys, slong n)
    ...
    fmpz_struct ** _fmpz_poly_tree_alloc(slong len)
    void _fmpz_poly_tree_free(fmpz_struct ** tree, slong len)
    void _fmpz_poly_tree_build_fmpq_vec(fmpz_struct ** tree, const fmpq_struct * roots, slong len)
    ...
    slong _fmpz_poly_positive_root_upper_bound_2exp_local_max(const fmpz_struct * pol, slong len)
    slong _fmpz_poly_positive_root_upper_bound_2exp(const fmpz_struct * pol, slong len)
    slong fmpz_poly_positive_root_upper_bound_2exp(const fmpz_poly_t pol)
    slong _fmpz_poly_descartes_bound_0_1(const fmpz_struct * p, slong len, slong bound)
    ...
    slong _fmpz_poly_num_real_roots_vca(const fmpz_struct * pol, slong len)
    ...
    int _fmpz_poly_has_real_root(const fmpz_struct * p, slong len)
    int fmpz_poly_has_real_root(const fmpz_poly_t pol)
    void _fmpz_poly_isolate_real_roots_0_1_vca(fmpq_struct * exact_roots, slong * n_exact_roots, fmpz_struct * c_array, slong * k_array, slong * n_intervals, const fmpz_struct * pol, slong len)
    void fmpz_poly_isolate_real_roots(fmpq_struct * exact_roots, slong * n_exact, fmpz_struct * c_array, slong * k_array, slong * n_interval, const fmpz_poly_t pol)
    void fmpz_poly_isolate_positive_roots(fmpq_struct * exact_roots, slong * n_exact, fmpz_struct * c_array, slong * k_array, slong * n_interval, const fmpz_poly_t pol)
