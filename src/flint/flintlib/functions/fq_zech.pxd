...
from flint.flintlib.types.fq_zech cimport fq_zech_ctx_t, fq_zech_t
...
cdef extern from "flint/fq_zech.h":
    ...
    void _fq_zech_pow(fmpz_struct * rop, const fmpz_struct * op, slong len, const fmpz_t e, const fmpz_struct * a, const slong * j, slong lena, const fmpz_t p)
    ...
    int fq_zech_multiplicative_order(fmpz_struct * ord, const fq_zech_t op, const fq_zech_ctx_t ctx)
