...
cdef extern from "flint/gr_generic.h":
    ...
    int _gr_fmpz_poly_evaluate_horner(gr_ptr res, const fmpz_struct * f, slong len, gr_srcptr x, gr_ctx_t ctx)
    int gr_fmpz_poly_evaluate_horner(gr_ptr res, const fmpz_poly_t f, gr_srcptr x, gr_ctx_t ctx)
    int _gr_fmpz_poly_evaluate_rectangular(gr_ptr res, const fmpz_struct * f, slong len, gr_srcptr x, gr_ctx_t ctx)
    int gr_fmpz_poly_evaluate_rectangular(gr_ptr res, const fmpz_poly_t f, gr_srcptr x, gr_ctx_t ctx)
    int _gr_fmpz_poly_evaluate(gr_ptr res, const fmpz_struct * f, slong len, gr_srcptr x, gr_ctx_t ctx)
    int gr_fmpz_poly_evaluate(gr_ptr res, const fmpz_poly_t f, gr_srcptr x, gr_ctx_t ctx)
    int gr_fmpz_mpoly_evaluate_iter(gr_ptr res, const fmpz_mpoly_t f, gr_srcptr x, const fmpz_mpoly_ctx_t mctx, gr_ctx_t ctx)
