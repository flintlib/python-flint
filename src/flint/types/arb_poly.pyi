...
class arb_poly(flint_poly[arb]):
    ...
    @overload
    def __add__(self, other: acb | complex, /) -> acb_poly: ...

    @overload
    def __radd__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __radd__(self, other: acb | complex, /) -> acb_poly: ...

    @overload  # type: ignore[override]
    def __sub__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __sub__(self, other: acb | complex, /) -> acb_poly: ...

    @overload
    def __rsub__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __rsub__(self, other: acb | complex, /) -> acb_poly: ...

    @overload  # type: ignore[override]
    def __mul__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __mul__(self, other: acb | complex, /) -> acb_poly: ...

    @overload
    def __rmul__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __rmul__(self, other: acb | complex, /) -> acb_poly: ...

    @overload  # type: ignore[override]
    def __floordiv__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __floordiv__(self, other: acb | complex, /) -> acb_poly: ...

    @overload
    def __rfloordiv__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __rfloordiv__(self, other: acb | complex, /) -> acb_poly: ...

    @overload  # type: ignore[override]
    def __mod__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __mod__(self, other: acb | complex, /) -> acb_poly: ...

    @overload
    def __rmod__(self, other: iarb_poly, /) -> arb_poly: ...
    @overload
    def __rmod__(self, other: acb | complex, /) -> acb_poly: ...

    @overload  # type: ignore[override]
    def __divmod__(self, other: iarb_poly, /) -> tuple[arb_poly, arb_poly]: ...
    @overload
    def __divmod__(self, other: acb | complex, /) -> tuple[acb_poly, acb_poly]: ...

    @overload
    def __rdivmod__(self, other: iarb_poly, /) -> tuple[arb_poly, arb_poly]: ...
    @overload
    def __rdivmod__(self, other: acb | complex, /) -> tuple[acb_poly, acb_poly]: ...
