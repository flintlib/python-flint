...
class fmpz_mod_poly_ctx:
    ...
    def random_element(self, degree: int = 3, monic: bool = False, irreducible: bool = False) -> fmpz_mod_poly: ...
...
class fmpz_mod_poly(flint_poly):
    """
    ...
    """
    def __init__(self, val: list[ifmpz_mod] | ifmpz_mod_poly, ctx): ...
    ...
    def __pow__(self, e: ifmpz, mod: ifmpz_mod_poly | None = None, /) -> fmpz_mod_poly: ...
    ...
    @overload
    def __call__(self, input: list[ifmpz_mod] | tuple[ifmpz_mod, ...]) -> list[fmpz_mod]: ...
    @overload
    ...
    def compose_mod(self, other: ifmpz_mod_poly, modulus: ifmpz_mod_poly) -> fmpz_mod_poly: ...
    ...
    def mul_mod(self, other: ifmpz_mod_poly, modulus: ifmpz_mod_poly) -> fmpz_mod_poly: ...
    def pow_mod(self, e: int, modulus: ifmpz_mod_poly | None = None, /) -> fmpz_mod_poly: ...

    def divmod(self, other: ifmpz_mod_poly) -> tuple[fmpz_mod, fmpz_mod_poly]: ...
    def __divmod__(self, other: ifmpz_mod_poly) -> tuple[fmpz_mod, fmpz_mod_poly]: ...
    def __rdivmod__(self, other: ifmpz_mod_poly) -> tuple[fmpz_mod, fmpz_mod_poly]: ...

    def gcd(self, other: ifmpz_mod_poly) -> fmpz_mod_poly: ...
    def xgcd(self, other: ifmpz_mod_poly) -> tuple[fmpz_mod_poly, fmpz_mod_poly, fmpz_mod_poly]: ...
    ...
    def factor(self, algorithm: str | None = None) -> tuple[fmpz_mod, list[tuple[fmpz_mod_poly, int]]]: ...

    @overload
    def roots(self, multiplicities: Literal[True] = ...) -> list[tuple[fmpz_mod, int]]: ...
    @overload
