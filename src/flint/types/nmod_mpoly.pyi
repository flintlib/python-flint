...
class nmod_mpoly(flint_mpoly[nmod_mpoly_ctx, nmod, inmod]):
    def __init__(self,
        val: nmod_mpoly | fmpz_mpoly | inmod | dict[tuple[int, ...], inmod] | str = 0,
    ...
    def subs(self, mapping: dict[str | int, inmod]) -> nmod_mpoly: ...
    ...
    def resultant(self, other: nmod_mpoly, var: str | int) -> nmod_mpoly: ...
    def discriminant(self, var: str | int) -> nmod_mpoly: ...
    ...
    def derivative(self, var: str | int) -> nmod_mpoly: ...
