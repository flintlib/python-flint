...
class fmpz_mpoly(flint_mpoly[fmpz_mpoly_ctx, fmpz, ifmpz]):
    ...
    def __init__(self,
        val: fmpz_mpoly | ifmpz | dict[tuple[int, ...], ifmpz] | str = 0,
    ...
    def subs(self, mapping: dict[str | int, ifmpz]) -> fmpz_mpoly: ...
    ...
    def resultant(self, other: fmpz_mpoly, var: str | int) -> fmpz_mpoly: ...
    def discriminant(self, var: str | int) -> fmpz_mpoly: ...
    ...
    def derivative(self, var: str | int) -> fmpz_mpoly: ...
    def integral(self, var: str | int) -> tuple[int, fmpz_mpoly]: ...
